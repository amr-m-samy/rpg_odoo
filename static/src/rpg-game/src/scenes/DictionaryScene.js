...
export class DictionaryScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.word = this.add.text(50, 50, this.wordId, {
      fontSize: "32px",
      fill: "#000",
    });
    this.definition = this.add.text(50, 100, "Definition", {
      fontSize: "32px",
      fill: "#000",
    });
    this.add.image(50, 150, "luminus_candle").setScale(0.5);

    this.scene.stop("ImagePreviewScene");
  ...
  changeSize(width, height) {
    if (this.cameras.main) {
      ...
      this.createCloseButton();
      this.word.x = this.cameras.main.midPoint.x;
      this.word.y = this.cameras.main.midPoint.y;
