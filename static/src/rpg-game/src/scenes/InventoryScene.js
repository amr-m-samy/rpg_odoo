...
export class InventoryScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.createItems();
    if (
      !LuminusUtils.isMobile() ||
      (LuminusUtils.isMobile() && this.input.gamepad.pad1)
    )
    ...
    if (this.cachedInterfaceControler) {
      this.luminusInterfaceController.recoverPositionFromPrevious(
        this.cachedInterfaceControler,
      );
    }
   ...
   */
  setGamepadTextures() {
    if (this && this.sys && this.backButtonLegend)
      this.backButtonLegend.setTexture(this.backButtonLegendConsole);
    ...
    if (this && this.sys && this.descriptionButtonLegend)
      this.descriptionButtonLegend.setTexture(
        this.descriptionButtonLegendConsole,
      );
  }
    ...
    for (let row = 0; row < slotsNumberVertical; row++) {
      for (let col = 0; col < slotsNumberHorizontal; col++) {
        ...
        if (slot) {
          ...
          if (slot.item) {
            let item = slot.item;
            slot.item.setPosition(
              slot.x + slot.width / 2,
              slot.y + slot.height / 2 - 7,
            );
            slot.text.setPosition(
              item.x,
  ...
  createLegendSection() {
    ...
    this.descriptionButtonLegend = this.add.sprite(
      this.actionButtonLegend.text.x +
        this.actionButtonLegend.text.width *
          this.actionButtonLegend.text.scaleX +
        this.slotMargin,
    ...
    this.descriptionButtonLegend.text = this.add.text(
      this.descriptionButtonLegend.x +
        this.descriptionButtonLegend.width *
          this.descriptionButtonLegend.scaleX +
        this.slotMargin,
    ...
    this.backButtonLegend = this.add.sprite(
      this.descriptionButtonLegend.text.x +
        this.descriptionButtonLegend.text.width *
          this.descriptionButtonLegend.text.scaleX +
        this.slotMargin,
