...
export class HUDScene extends Phaser.Scene {
  constructor() {
    ...
    this.attributesShortcutIconDesktop =
      IconNamesConst.HUDScene.attributes.desktop;
    /**
  ...
  create() {
    ...
    this.inventoryIcon.on("pointerup", (pointer) => {
      SceneToggleWatcher.toggleScene(
        this,
        this.inventorySceneName,
        this.player,
      );
    });
    ...
    this.input.gamepad.on("disconnected", (pad) => {
      ...
      this.attributesShortcutIcon.setTexture(
        this.attributesShortcutIconDesktop,
      );
    });
    ...
    this.level_text = this.add.text(
      15,
      75,
      "LvL " + this.player.attributes.level,
    );
  }
  ...
  setGamepadTextures() {
    ...
    if (this.inventoryShortcutIcon)
      this.inventoryShortcutIcon.setTexture(this.inventoryShortcutIconXbox);
    if (this.attributesShortcutIcon)
      this.attributesShortcutIcon.setTexture(this.attributesShortcutIconXbox);
  ...
  resizeAll(size) {
    if (this.maximize)
      this.maximize.setPosition(
        size.width - this.maximizeSpriteOffsetX,
        this.maximizeSpriteOffsetY,
      );

    if (this.settingsIcon)
      this.settingsIcon.setPosition(
        size.width - this.settingsSpriteOffsetX,
        this.settingsSpriteOffsetY,
      );

    this.inventoryIcon.setPosition(
      size.width - this.inventorySpriteOffsetX,
      this.inventorySpriteOffsetY,
    );
    if (this.inventoryShortcutIcon)
      this.inventoryShortcutIcon.setPosition(
        this.settingsIcon.x - 70,
        this.settingsIcon.y + 15,
      );
  ...
  update() {
    if (this.level_text)
      this.level_text.setText("LvL " + this.player.attributes.level);
  }
}
