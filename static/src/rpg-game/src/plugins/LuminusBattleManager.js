...
export class LuminusBattleManager extends AnimationNames {
  ...
  takeDamage(atacker, target) {
    ...
    if (hit || isCritical) {
      ...
      // Not very Optimized.
      this.luminusEntityTextDisplay = new LuminusEntityTextDisplay(
        target.scene,
      );
